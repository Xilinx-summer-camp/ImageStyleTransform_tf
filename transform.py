...
#tf.app.flags.DEFINE_string("model_file", "models\painting\painting.ckpt-2000", "风格模型")
tf.app.flags.DEFINE_string("model_file", "models\\wave.ckpt-done", "风格模型")
tf.app.flags.DEFINE_string("image_file", "img\content\\test3.jpg", "输入图片")
tf.app.flags.DEFINE_string('target_file', 'img\\results\\result3_wave.jpg', '转换风格后的图片')
